...
public class ProductService {
    ...
    private final String SERVICE_NAME = "product";
    ...
    @Cacheable(
            ...
            key = "#productId",
            condition = "#role != " + UserRoleEnum.Authority.MASTER
    )
...
//    @Transactional
//    public Response<Void> decreaseProductStock(ProductPurchaseRequestDto productPurchaseRequestDto, String role) {
//
//    }
